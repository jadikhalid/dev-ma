    ...
    >
        ...
        <div class="min-h-0 flex-1 overflow-y-auto px-5 py-4 sm:px-6">
            ...
            <div x-show="!searchLoading && results.length" class="space-y-4">
                {{-- 2 aperçus anonymisés (initiales uniquement) --}}
                <template x-for="talent in results" :key="talent.id">
                ...
                {{-- 3e carte grisée (aperçu verrouillé) --}}
                ...
                {{-- CTA entreprise sous le pavé grisé --}}
