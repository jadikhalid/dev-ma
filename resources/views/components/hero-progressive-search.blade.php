        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-2.5">
            ...
            <div class="relative">
                ...
                <select
                    ...
                    required
                >
                    <option value="">{{ __('talenma.home.search_profession_required') }}</option>
