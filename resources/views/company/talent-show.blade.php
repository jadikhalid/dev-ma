@php
    ...
    $lockedDirectHire = $lockedDirectHire ?? null;
...
<x-app-layout>
    <x-slot name="header">
        ...
        @if (($existingNamedRequest?->hasActiveTalentLock()) || $lockedDirectHire)
            <div class="mt-3 inline-flex items-center gap-1.5 rounded-full bg-amber-100 px-2.5 py-1 text-xs font-bold uppercase tracking-wide text-amber-900 ring-1 ring-amber-200">
