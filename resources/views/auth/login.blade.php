        ...
        <div class="flex flex-col h-full min-h-0">
            ...
            <form method="POST" action="{{ route('login') }}" class="flex flex-col flex-1 min-h-0">@csrf
                ...
                <div class="mt-5 sm:mt-4">
                    ...
                    <x-text-input id="password" name="password" type="password" class="mt-1.5 block w-full !text-base !py-3 sm:mt-1 sm:!py-2" required />
                </div>
                <label class="flex items-center mt-5 sm:mt-4">
                    <input type="checkbox" name="remember" class="size-5 sm:size-4 rounded text-indigo-600">
