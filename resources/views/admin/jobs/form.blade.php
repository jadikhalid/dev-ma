            ...
            >
                ...
                <div>
                    ...
                    <x-text-input
                        ...
                        maxlength="255"
                        data-required
                        data-required-message="{{ __('talenma.jobs.title_required') }}"
                    />
                ...
                <div>
                    ...
                    <textarea
                        ...
                        maxlength="10000"
                        data-required
                        data-required-message="{{ __('talenma.jobs.description_required') }}"
                        data-min-length="50"
                        data-min-length-message="{{ __('talenma.jobs.description_min') }}"
